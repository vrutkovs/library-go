...
type ClusterImagePolicyLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*configv1.ClusterImagePolicy, err error)
	// Get retrieves the ClusterImagePolicy from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*configv1.ClusterImagePolicy, error)
