...
type ClusterTrustBundleLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*certificatesv1alpha1.ClusterTrustBundle, err error)
	// Get retrieves the ClusterTrustBundle from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*certificatesv1alpha1.ClusterTrustBundle, error)
