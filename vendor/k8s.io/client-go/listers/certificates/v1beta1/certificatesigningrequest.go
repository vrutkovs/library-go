...
type CertificateSigningRequestLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*certificatesv1beta1.CertificateSigningRequest, err error)
	// Get retrieves the CertificateSigningRequest from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*certificatesv1beta1.CertificateSigningRequest, error)
