...
type RoleBindingLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*rbacv1beta1.RoleBinding, err error)
...
type RoleBindingNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*rbacv1beta1.RoleBinding, error)
