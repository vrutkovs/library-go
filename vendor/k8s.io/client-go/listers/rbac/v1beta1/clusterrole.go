...
type ClusterRoleLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*rbacv1beta1.ClusterRole, err error)
	// Get retrieves the ClusterRole from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*rbacv1beta1.ClusterRole, error)
