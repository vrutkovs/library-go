...
type ControllerRevisionLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*appsv1beta1.ControllerRevision, err error)
...
type ControllerRevisionNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*appsv1beta1.ControllerRevision, error)
