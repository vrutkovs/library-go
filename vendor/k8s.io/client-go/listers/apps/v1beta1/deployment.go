...
type DeploymentLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*appsv1beta1.Deployment, err error)
...
type DeploymentNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*appsv1beta1.Deployment, error)
