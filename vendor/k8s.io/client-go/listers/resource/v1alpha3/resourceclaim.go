...
type ResourceClaimLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*resourcev1alpha3.ResourceClaim, err error)
...
type ResourceClaimNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*resourcev1alpha3.ResourceClaim, error)
