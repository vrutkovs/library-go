...
type ResourceSliceLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*resourcev1beta1.ResourceSlice, err error)
	// Get retrieves the ResourceSlice from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*resourcev1beta1.ResourceSlice, error)
