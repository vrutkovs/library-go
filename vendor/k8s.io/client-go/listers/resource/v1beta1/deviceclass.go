...
type DeviceClassLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*resourcev1beta1.DeviceClass, err error)
	// Get retrieves the DeviceClass from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*resourcev1beta1.DeviceClass, error)
