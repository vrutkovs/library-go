...
type ResourceClaimTemplateLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*resourcev1beta1.ResourceClaimTemplate, err error)
...
type ResourceClaimTemplateNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*resourcev1beta1.ResourceClaimTemplate, error)
