...
type ValidatingAdmissionPolicyBindingLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*admissionregistrationv1.ValidatingAdmissionPolicyBinding, err error)
	// Get retrieves the ValidatingAdmissionPolicyBinding from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*admissionregistrationv1.ValidatingAdmissionPolicyBinding, error)
