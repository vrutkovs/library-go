...
type ValidatingAdmissionPolicyLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*admissionregistrationv1beta1.ValidatingAdmissionPolicy, err error)
	// Get retrieves the ValidatingAdmissionPolicy from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*admissionregistrationv1beta1.ValidatingAdmissionPolicy, error)
