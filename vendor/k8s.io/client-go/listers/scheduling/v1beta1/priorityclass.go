...
type PriorityClassLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*schedulingv1beta1.PriorityClass, err error)
	// Get retrieves the PriorityClass from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*schedulingv1beta1.PriorityClass, error)
