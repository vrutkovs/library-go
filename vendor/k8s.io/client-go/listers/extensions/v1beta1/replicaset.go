...
type ReplicaSetLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*extensionsv1beta1.ReplicaSet, err error)
...
type ReplicaSetNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*extensionsv1beta1.ReplicaSet, error)
