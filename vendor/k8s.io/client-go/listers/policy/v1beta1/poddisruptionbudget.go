...
type PodDisruptionBudgetLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*policyv1beta1.PodDisruptionBudget, err error)
...
type PodDisruptionBudgetNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*policyv1beta1.PodDisruptionBudget, error)
