...
type EndpointSliceLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*discoveryv1.EndpointSlice, err error)
...
type EndpointSliceNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*discoveryv1.EndpointSlice, error)
