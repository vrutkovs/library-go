...
type IngressClassLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*networkingv1beta1.IngressClass, err error)
	// Get retrieves the IngressClass from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*networkingv1beta1.IngressClass, error)
