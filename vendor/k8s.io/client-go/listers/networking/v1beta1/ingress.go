...
type IngressLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*networkingv1beta1.Ingress, err error)
...
type IngressNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*networkingv1beta1.Ingress, error)
