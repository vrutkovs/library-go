...
type VolumeAttachmentLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*storagev1beta1.VolumeAttachment, err error)
	// Get retrieves the VolumeAttachment from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*storagev1beta1.VolumeAttachment, error)
