...
type VolumeAttributesClassLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*storagev1alpha1.VolumeAttributesClass, err error)
	// Get retrieves the VolumeAttributesClass from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*storagev1alpha1.VolumeAttributesClass, error)
