...
type APIServiceLister interface {
	...
	List(ctx context.Context, selector labels.Selector) (ret []*apiregistrationv1beta1.APIService, err error)
	// Get retrieves the APIService from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(ctx context.Context, name string) (*apiregistrationv1beta1.APIService, error)
